...
'''
This converts MANO to UIUC Hand by simple direct joint-to-joint angle mapping.
...
class ManoRetargeter:
    ...
    #  transform order of right hand
        ...
        #    9-- 8 -- 7 --/
        '''
        This takes the euler angles from the axis_layer outputs and maps them directly to the 16 joint angles in the UIUC Hand by extracting the right component of the euler.
        '''
...
if __name__ == "__main__":
    ...
    uiuc_hand_output = mano_retargeter.mano_retarget(joint_pose, shape_params)
    print(uiuc_hand_output)
